...
copy >nul "1. Base Assets\1. Data Entries\Codex_NAME.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\NAME.json"
copy >nul "1. Base Assets\1. Data Entries\Dangerroom_NAME.json" "..\..\3. General Data Files\dangerroom\1. Base Assets\0. Danger Room Entries\NAME.json"
