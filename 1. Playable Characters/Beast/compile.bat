@echo off
echo Compiling Beast's character assets 
...
set pcPkgb=beast_hero_0501.pkgb.json
set pcPkgbNc=beast_hero_0501_nc.pkgb.json
...
set simpleCompileNPC1=simpleCompile_Beast
set simpleCompileNPC2=simpleCompile_BeastBoss
