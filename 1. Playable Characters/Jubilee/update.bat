...
copy >nul "1. Base Assets\1. Data Entries\Codex_Jubilee.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Jubilee.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Jubilee.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Jubilee.txt"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Jubilee.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Jubilee.json"
