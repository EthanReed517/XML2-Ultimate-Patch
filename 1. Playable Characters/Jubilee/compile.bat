@echo off
echo Compiling Jubilee's character assets 
...
set pcPkgb=jubilee_15101.pkgb.json
set pcPkgbNc=jubilee_15101_nc.pkgb.json
...
set simpleCompilePlayable=simpleCompile_Jubilee
set simpleCompileNPC1=""
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\15108.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\15109.igb"
	del >nul "0. Staging\actors\15108.igb"
	del >nul "0. Staging\actors\15109.igb"
	del >nul "0. Staging\hud\hud_head_15108.igb"
	del >nul "0. Staging\hud\hud_head_15109.igb"
	del >nul "0. Staging\ui\hud\characters\15108.igb"
	del >nul "0. Staging\ui\hud\characters\15109.igb"
)
goto compilePCcont
