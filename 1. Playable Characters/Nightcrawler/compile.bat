@echo off
echo Compiling Nightcrawler's character assets 
...
set pcPkgb=nightcrawler_0601.pkgb.json
set pcPkgbNc=nightcrawler_0601_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=nightcrawler_mc_20019
set npcName2=nightcrawlersimple_0601
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
if  %consoleChoice%==PC (
	...
	del >nul "0. Staging\ui\hud\characters\0609.igb"
)
goto compilePCcont
