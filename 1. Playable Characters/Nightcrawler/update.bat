...
copy >nul "1. Base Assets\1. Data Entries\Codex_Nightcrawler.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Nightcrawler.json"
copy >nul "1. Base Assets\1. Data Entries\Dangerroom_Nightcrawler.json" "..\..\3. General Data Files\dangerroom\1. Base Assets\0. Danger Room Entries\Nightcrawler.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Nightcrawler.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Nightcrawler.txt"
copy >nul "1. Base Assets\1. Data Entries\Items_Nightcrawler.json" "..\..\3. General Data Files\items\1. Base Assets\0. Items Entries\Nightcrawler.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_NightcrawlerSimple.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\NightcrawlerSimple.json"
copy >nul "1. Base Assets\1. Data Entries\NPCStat_Nightcrawler_MC.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\Nightcrawler_MC.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Nightcrawler.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Nightcrawler.json"
