...
set pcPkgb=cyclops_0101.pkgb.json
set pcPkgbNc=cyclops_0101_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=cyclops_mc_20012
set npcName2=cyclopssimple_0101
set npcName3=sin_cyc_0100
set npcName4=""
set npcName5=""
set npcName6=""

REM fill in the name of the character's simple compilers here (without the file extension)
set simpleCompilePlayable=simpleCompile_Cyclops
set simpleCompileNPC1=simpleCompile_Cyclops_mc
set simpleCompileNPC2=simpleCompile_CyclopsSimple
set simpleCompileNPC3=simpleCompile_Sin_Cyc
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\01_cyclops.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_cyclops.igb"
	rmdir /s /q "0. Staging\models\powers"
)
goto compilePCcont
