...
set codexEntry=Cyclops
set dangerEntry=Cyclops
set herostatEntry=Cyclops
set itemsEntry=Cyclops
...
set mapPath=..\..\5. Maps\act0\tutorial\tutorial1
copy >nul "%BaseFolder%\%NoCelFolder%\actors\0101.igb" "%mapPath%\%BaseFolder%\%NoCelFolder%\actors"
copy >nul "%BaseFolder%\actors\0101.igb" "%mapPath%\%BaseFolder%\actors"
copy >nul "%BaseFolder%\hud\hud_head_0101.igb" "%mapPath%\%BaseFolder%\hud"
copy >nul "%GCFolder%\%NoCelFolder%\actors\0101.igb" "%mapPath%\%GCFolder%\%NoCelFolder%\actors"
copy >nul "%GCFolder%\actors\0101.igb" "%mapPath%\%GCFolder%\actors"
copy >nul "%PSPFolder%\actors\0101.igb" "%mapPath%\%PSPFolder%\actors"
copy >nul "%PSPFolder%\hud\hud_head_0101.igb" "%mapPath%\%PSPFolder%\hud"
