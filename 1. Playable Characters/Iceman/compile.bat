...
set npcName1=iceman_mc_20001
set npcName2=icemansimple_0801
set npcName3=sin_ice_0800
set npcName4=""
set npcName5=""
set npcName6=""

REM fill in the name of the character's simple compilers here (without the file extension)
set simpleCompilePlayable=simpleCompile_Iceman
set simpleCompileNPC1=simpleCompile_Iceman_mc
set simpleCompileNPC2=simpleCompile_IcemanSimple
set simpleCompileNPC3=simpleCompile_Sin_Ice
