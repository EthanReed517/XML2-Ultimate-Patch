@echo off
echo Compiling Playable Character - Iceman
...
set packageName=iceman_08
REM playable characters need the name of the xml packages listed as well
set xmlPackageName=iceman_xml
REM define other values for the compiler
set comicCover=iceman_cov
set effectsFolder=iceman
set loadingScreen1=0801
set loadingScreen2=0802
set loadingScreen3=0803
set powerstyle=ps_iceman
set soundFile=iceman_m
