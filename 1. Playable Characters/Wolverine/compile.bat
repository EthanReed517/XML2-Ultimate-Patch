...
set pcPkgb=wolverine_0301.pkgb.json
set pcPkgbNc=wolverine_0301_nc.pkgb.json
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\03_wolverine.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_wolverine.igb"
)
goto compilePCcont
