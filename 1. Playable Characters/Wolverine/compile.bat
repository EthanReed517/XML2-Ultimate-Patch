@echo off
echo Compiling Wolverine's character assets 
...
copy >nul "..\..\0. Compilers" "0. Staging"
REM move packages
move >nul "0. Staging\packages\generated\characters\wolverine_0301.pkgb.json" "0. Staging"
move >nul "0. Staging\packages\generated\characters\wolverine_0301_nc.pkgb.json" "0. Staging"
REM change directory to 0. Staging folder and execute scripts
cd "%~dp0\0. Staging"
