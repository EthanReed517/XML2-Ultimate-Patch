...
set dangerEntry=Wolverine
set herostatEntry=Wolverine
set itemsEntry=Wolverine
set npcstatEntry1=Wolverine_MC
set npcstatEntry2=WolverineSimple
set npcstatEntry3=Sin_Wolv
set reviewEntry=Wolverine
