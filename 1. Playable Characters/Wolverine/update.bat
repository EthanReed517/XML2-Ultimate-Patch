...
copy >nul "1. Base Assets\1. Data Entries\Reviewpaths_Wolverine.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Wplverine.json"
