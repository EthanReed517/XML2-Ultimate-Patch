...
copy >nul "1. Base Assets\1. Data Entries\Codex_Psylocke.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Psylocke.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Psylocke.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Psylocke.txt"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Psylocke.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Psylocke.json"
