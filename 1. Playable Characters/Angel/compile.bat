@echo off
echo Compiling Angel's character assets
...
set pcPkgb=angel_hero_1002.pkgb.json
set pcPkgbNc=angel_hero_1002_nc.pkgb.json
...
set simpleCompilePlayable=simpleCompile_Angel_Hero
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\1010.igb"
	del >nul "0. Staging\actors\1010.igb"
	del >nul "0. Staging\hud\hud_head_1010.igb"
	del >nul "0. Staging\ui\hud\characters\1010.igb"
)
goto compilePCcont
