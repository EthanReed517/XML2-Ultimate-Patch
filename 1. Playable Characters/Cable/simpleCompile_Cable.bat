@echo off
echo Compiling Playable Character - Cable
...
set packageName=cable_115
REM playable characters need the name of the xml packages listed as well
set xmlPackageName=cable_xml
REM define other values for the compiler
set comicCover=""
set effectsFolder=cable
set loadingScreen1=11501
set loadingScreen2=""
set loadingScreen3=""
set powerstyle=ps_cable
set soundFile=cable_m
