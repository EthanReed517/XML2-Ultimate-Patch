...
copy >nul "1. Base Assets\1. Data Entries\Codex_Cable.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Cable.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Cable.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Cable.txt"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Cable.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Cable.json"
