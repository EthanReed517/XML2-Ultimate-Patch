@echo off
echo Compiling Cable's character assets 
...
set simpleCompilePlayable=simpleCompile_Cable
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\11503.igb"
	del >nul "0. Staging\actors\11503.igb"
	del >nul "0. Staging\hud\hud_head_11503.igb"
	del >nul "0. Staging\ui\hud\characters\11503.igb"
)
goto compilePCcont
