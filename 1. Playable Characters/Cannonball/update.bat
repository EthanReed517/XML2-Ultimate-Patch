...
copy >nul "1. Base Assets\1. Data Entries\Codex_Cannonball.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Cannonball.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Cannonball.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Cannonball.txt"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Cannonball.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Cannonball.json"
