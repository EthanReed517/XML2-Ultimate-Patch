@echo off
echo Compiling Jean Grey's character assets 
...
set pcPkgb=phoenix_0201.pkgb.json
set pcPkgbNc=phoenix_0201_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=phoenix_mc_20016
set npcName2=phoenixsimple_0201
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
set simpleCompilePlayable=simpleCompile_Phoenix
set simpleCompileNPC1=simpleCompile_Phoenix_mc
set simpleCompileNPC2=simpleCompile_PhoenixSimple
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\02_jean_grey.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_jeangrey.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\0209.igb"
	del >nul "0. Staging\actors\0209.igb"
	del >nul "0. Staging\hud\hud_head_0209.igb"
	del >nul "0. Staging\ui\hud\characters\0209.igb"
)
goto compilePCcont
