...
copy >nul "1. Base Assets\1. Data Entries\Codex_Phoenix.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Phoenix.json"
copy >nul "1. Base Assets\1. Data Entries\Dangerroom_Phoenix.json" "..\..\3. General Data Files\dangerroom\1. Base Assets\0. Danger Room Entries\Phoenix.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Phoenix.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Phoenix.txt"
copy >nul "1. Base Assets\1. Data Entries\Items_Phoenix.json" "..\..\3. General Data Files\items\1. Base Assets\0. Items Entries\Phoenix.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_PhoenixSimple.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\PhoenixSimple.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_Phoenix_MC.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\Phoenix_MC.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Phoenix.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Phoenix.json"
