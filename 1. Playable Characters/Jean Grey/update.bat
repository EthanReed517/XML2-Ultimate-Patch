...
set codexEntry=Phoenix
set dangerEntry=Phoenix
set herostatEntry=Phoenix
set itemsEntry=Phoenix
set npcstatEntry1=Phoenix_MC
set npcstatEntry2=PhoenixSimple
set npcstatEntry3=""
set reviewEntry=Phoenix
