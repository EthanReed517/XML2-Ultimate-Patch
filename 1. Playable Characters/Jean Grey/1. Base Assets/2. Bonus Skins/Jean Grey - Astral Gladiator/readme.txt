...
Jean Grey - Astral Gladiator Skin
By BaconWizard17

General Information
- The file called 02XX (Skin).igb is the skin. It goes in the Actors folder.
- The file called 02XX (Skin - No Cel).igb is the skin but without the cel shading (black outline). It goes in the Actors folder. It is an alternative to the main skin, so use one or the other. 
- The file called hud_head_02XX.igb is the conversation portrait for this skin. It goes in the HUD folder.
- The file called 02XX (3D Head).igb is the 3D head for this skin. It goes in the folder UI/hud/characters. 

Hex editing info:
- The internal number of the skin is 0201.
- The internal number of the conversation portrait is 0201.
- The internal number of the 3D head is 0201.
