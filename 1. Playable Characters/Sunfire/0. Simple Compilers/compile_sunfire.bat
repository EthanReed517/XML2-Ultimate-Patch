@echo off
echo Compiling Playable Character - Sunfire
...
set charName=sunfire
set charNum=12
REM define other values for the compiler
set effectsFolder=sun
set loadingScreen1=1201
set loadingScreen2=""
set loadingScreen3=""
set powerstyle=ps_sunfire
set soundFile=sunfire_m
