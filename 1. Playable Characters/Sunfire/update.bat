...
set codexEntry=Sunfire
set dangerEntry=Sunfire
set herostatEntry=Sunfire
set itemsEntry=Sunfire
set npcstatEntry1=Sunfire_MC
set npcstatEntry2=SunfireSimple
set npcstatEntry3=""
set reviewEntry=Sunfire
