@echo off
echo Compiling Sunfire's character assets 
...
set pcPkgb=sunfire_1201.pkgb.json
set pcPkgbNc=sunfire_1201_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=sunfire
...
if  %consoleChoice%==PC (
	...
	del >nul "0. Staging\actors\200_sunfire.igb"
