...
set codexEntry=Storm
set dangerEntry=Storm
set herostatEntry=Storm
set itemsEntry=Storm
set npcstatEntry1=Sin_Storm
set npcstatEntry2=Storm_MC
set npcstatEntry3=StormSimple
set reviewEntry=Storm
