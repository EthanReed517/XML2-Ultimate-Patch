...
if %skinPackChoice%==2 (
	...
	if %celChoice%==N (
		robocopy >nul /e /v "3. Redesign Assets - GameCube\3. No Cel Shade Assets" "0. Staging"
	)
)
if %skinPackChoice%==3 (
...
if %skinPackChoice%==2 (
	...
	if %celChoice%==N (
		robocopy >nul /e /v "3. Redesign Assets - PS2\3. No Cel Shade Assets" "0. Staging"
	)
)
if %skinPackChoice%==3 (
...
if %skinPackChoice%==2 (
	...
	if %celChoice%==N (
		robocopy >nul /e /v "3. Redesign Assets - Xbox\3. No Cel Shade Assets" "0. Staging"
	)
)
if %skinPackChoice%==3 (
