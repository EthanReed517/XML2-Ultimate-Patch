@echo off
echo Compiling Playable Character - Storm
...
set effectsFolder=storm
set loadingScreen1=0401
set loadingScreen2=0402
set loadingScreen3=0403
set powerstyle=ps_storm
set soundFile=storm_m
