...
copy >nul "1. Base Assets\1. Data Entries\Codex_EmmaFrost.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\EmmaFrost.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_EmmaFrost.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\EmmaFrost.txt"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_Frost.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\Frost.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_EmmaFrost.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\EmmaFrost.json"
