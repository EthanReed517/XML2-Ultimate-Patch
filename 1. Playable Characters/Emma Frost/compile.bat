@echo off
echo Compiling Emma Frost's character assets 
...
set pcPkgb=emmafrost_hero_9001.pkgb.json
set pcPkgbNc=emmafrost_hero_9001_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=frost_9001
set npcName2=""
set npcName3=""
set npcName4=""
set npcName5=""
...
set simpleCompilePlayable=simpleCompile_EmmaFrost_Hero
set simpleCompileNPC1=simpleCompile_Frost
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\9009.igb"
	del >nul "0. Staging\actors\9009.igb"
	del >nul "0. Staging\hud\hud_head_9009.igb"
	del >nul "0. Staging\ui\hud\characters\9009.igb"
)
goto compilePCcont
...
if %modeChoice%==full (
	...
	REM NPC packages (and restore original diamond skin name)
	...
	ren frost_xml.fb.txt frost_xml.fb.cfg
	call fbbuilder.bat
	ren *.txt *.cfg
