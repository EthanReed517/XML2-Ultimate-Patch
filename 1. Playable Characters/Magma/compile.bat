@echo off
echo Compiling Magma's character assets 
...
set simpleCompilePlayable=simpleCompile_Magma
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\3608.igb"
	del >nul "0. Staging\actors\3608.igb"
	del >nul "0. Staging\hud\hud_head_3608.igb"
	del >nul "0. Staging\ui\hud\characters\3608.igb"
)
goto compilePCcont
