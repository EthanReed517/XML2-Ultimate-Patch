@echo off
echo Compiling Scarlet Witch's character assets 
...
set pcPkgb=scarletwitch_2401.pkgb.json
set pcPkgbNc=scarletwitch_2401_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=scarletwitch
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\24_scarlet_witch.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_scarletwitch.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\2408.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\2409.igb"
	del >nul "0. Staging\actors\2408.igb"
	del >nul "0. Staging\actors\2409.igb"
	del >nul "0. Staging\hud\hud_head_2408.igb"
	del >nul "0. Staging\hud\hud_head_2409.igb"
	del >nul "0. Staging\ui\hud\characters\2408.igb"
	del >nul "0. Staging\ui\hud\characters\2409.igb"
)
goto compilePCcont
