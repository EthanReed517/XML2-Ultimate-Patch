...
copy >nul "1. Base Assets\1. Data Entries\Codex_ScarletWitch.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\ScarletWitch.json"
copy >nul "1. Base Assets\1. Data Entries\Dangerroom_ScarletWitch.json" "..\..\3. General Data Files\dangerroom\1. Base Assets\0. Danger Room Entries\ScarletWitch.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_ScarletWitch.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\ScarletWitch.txt"
copy >nul "1. Base Assets\1. Data Entries\Items_ScarletWitch.json" "..\..\3. General Data Files\items\1. Base Assets\0. Items Entries\ScarletWitch.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_ScarletWitch_MC.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\ScarletWitch_MC.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_ScarletWitchSimple.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\ScarletWitchSimple.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_ScarletWitch.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\ScarletWitch.json"
