@echo off
echo Compiling Playable Character - ScarletWitch
...
set charName=scarletwitch
set charNum=21
REM define other values for the compiler
set effectsFolder=switch
set loadingScreen1=2401
set loadingScreen2=""
set loadingScreen3=""
set powerstyle=ps_scarletwitch
set soundFile=switch_m
