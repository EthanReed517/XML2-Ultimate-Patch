...
set codexEntry=Gambit
set dangerEntry=Gambit
set herostatEntry=Gambit
set itemsEntry=Gambit
set npcstatEntry1=Gambit_MC
set npcstatEntry2=GambitSimple
set npcstatEntry3=""
set reviewEntry=Gambit
