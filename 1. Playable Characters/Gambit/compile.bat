...
set pcPkgb=gambit_1301.pkgb.json
...
set simpleCompilePlayable=simpleCompile_Gambit
set simpleCompileNPC1=simpleCompile_Gambit_mc
set simpleCompileNPC2=simpleCompile_GambitSimple
...
if  %consoleChoice%==PC (
	...
	del >nul "0. Staging\3. No Cel Shade Assets\actors\1309.igb"
	del >nul "0. Staging\actors\1309.igb"
	del >nul "0. Staging\hud\hud_head_1309.igb"
	del >nul "0. Staging\ui\hud\characters\1309.igb"
)
goto compilePCcont
