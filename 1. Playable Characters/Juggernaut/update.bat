...
set codexEntry=Juggernaut
set dangerEntry=Juggernaut
set herostatEntry=Juggernaut
set itemsEntry=Juggernaut
set npcstatEntry1=Juggernaut_MC
set npcstatEntry2=JuggernautSimple
set npcstatEntry3=""
set reviewEntry=Juggernaut
