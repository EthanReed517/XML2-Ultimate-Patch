@echo off
echo Compiling Toad's character assets 
...
set pcPkgb=toad_3301.pkgb.json
set pcPkgbNc=toad_3301_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=toad
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\33_toad.igb"
	del >nul "0. Staging\actors\33_toad_tongue.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_toad.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\3309.igb"
	del >nul "0. Staging\actors\3309.igb"
	del >nul "0. Staging\hud\hud_head_3309.igb"
	del >nul "0. Staging\ui\hud\characters\3309.igb"
	del >nul "0. Staging\actors\3310.igb"
