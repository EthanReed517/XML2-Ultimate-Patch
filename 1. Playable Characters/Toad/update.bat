...
copy >nul "1. Base Assets\1. Data Entries\Codex_Toad.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Toad.json"
copy >nul "1. Base Assets\1. Data Entries\Dangerroom_Toad.json" "..\..\3. General Data Files\dangerroom\1. Base Assets\0. Danger Room Entries\Toad.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Toad.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Toad.txt"
copy >nul "1. Base Assets\1. Data Entries\Items_Toad.json" "..\..\3. General Data Files\items\1. Base Assets\0. Items Entries\Toad.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_Toad_MC.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\Toad_MC.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_ToadSimple.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\ToadSimple.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Toad.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Toad.json"
