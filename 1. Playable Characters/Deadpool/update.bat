...
set codexEntry=Deadpool
set dangerEntry=Deadpool
set herostatEntry=Deadpool
set itemsEntry=Deadpool
set npcstatEntry1=Deadpool_Boss
set npcstatEntry2=DeadpoolSimple
set npcstatEntry3=""
set reviewEntry=Deadpool
