...
set pcPkgb=deadpool_4402.pkgb.json
set pcPkgbNc=deadpool_4402_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=deadpool_boss_4401
set npcName2=deadpoolsimple_4402
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
set simpleCompilePlayable=simpleCompile_Deadpool
set simpleCompileNPC1=simpleCompile_Deadpool_Boss
set simpleCompileNPC2=simpleCompile_DeadpoolSimple
