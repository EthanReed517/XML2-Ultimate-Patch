@echo off
echo Compiling Sabretooth's character assets 
...
set pcPkgb=sabretooth_hero_2901.pkgb.json
set pcPkgbNc=sabretooth_hero_2901_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=sabretooth_hero
