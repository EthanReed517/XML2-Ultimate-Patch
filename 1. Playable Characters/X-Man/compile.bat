@echo off
echo Compiling X-Man's character assets 
...
set pcPkgb=xman_3501.pkgb.json
set pcPkgbNc=xman_3501_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=xman
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\3508.igb"
	del >nul "0. Staging\actors\3508.igb"
	del >nul "0. Staging\hud\hud_head_3508.igb"
	del >nul "0. Staging\ui\hud\characters\3508.igb"
)
goto compilePCcont
