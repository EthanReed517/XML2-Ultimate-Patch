...
copy >nul "1. Base Assets\1. Data Entries\Codex_XMan.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\XMan.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_XMan.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\XMan.txt"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_XMan.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\XMan.json"
