...
copy >nul "1. Base Assets\1. Data Entries\Codex_Pyro.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\Pyro.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_Pyro.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\Pyro.txt"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_Pyro.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\Pyro.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_Pyro.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\Pyro.json"
