@echo off
echo Compiling Pyro's character assets 
...
set pcPkgb=pyro_hero_11401.pkgb.json
set pcPkgbNc=pyro_hero_11401_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=pyro_hero
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\114_pyro.igb"
	del >nul "0. Staging\actors\114_pyro_hero.igb"
