@echo off
echo Compiling Playable Character - Pyro_Hero
...
set charName=pyro_hero
set charNum=114
REM define other values for the compiler
set effectsFolder=pyrohero
set loadingScreen1=11401
set loadingScreen2=11402
set loadingScreen3=""
set powerstyle=ps_pyro_hero
set soundFile=pcpyro_m
