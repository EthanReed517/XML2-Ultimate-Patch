...
set codexEntry=Colossus
set dangerEntry=Colossus
set herostatEntry=Colossus
set itemsEntry=Colossus
set npcstatEntry1=Colossus_MC
set npcstatEntry2=ColossusSimple
set npcstatEntry3=""
set reviewEntry=Colossus
