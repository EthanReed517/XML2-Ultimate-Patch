@echo off
echo Compiling Colossus's character assets 
...
set pcPkgb=colossus_0901.pkgb.json
set pcPkgbNc=colossus_0901_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=colossus_mc_20011
set npcName2=colossussimple_0901
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
set simpleCompilePlayable=simpleCompile_Colossus
set simpleCompileNPC1=simpleCompile_Colossus_MC
set simpleCompileNPC2=simpleCompile_ColossusSimple
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\09_colossus.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_colossus.igb"
)
goto compilePCcont
