...
set pcPkgb=bishop_1801.pkgb.json
set pcPkgbNc=bishop_1801_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=bishop_mc_20010
set npcName2=bishopsimple_1801
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
set simpleCompilePlayable=simpleCompile_Bishop
set simpleCompileNPC1=simpleCompile_Bishop_MC
set simpleCompileNPC2=simpleCompile_BishopSimple
