...
set codexEntry=ProfessorX
set dangerEntry=ProfessorX
set herostatEntry=ProfessorX
set itemsEntry=""
set npcstatEntry1=ProfX_MC
set npcstatEntry2=ProfX
set npcstatEntry3=ProfXCaptive
set reviewEntry=ProfessorX
