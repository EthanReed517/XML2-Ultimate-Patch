@echo off
echo Compiling Professor X's character assets 
...
set pcPkgb=professorx_1102.pkgb.json
set pcPkgbNc=professorx_1102_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=professorx
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\11_professorx.igb"
	del >nul "0. Staging\actors\11_professorx_hero.igb"
	del >nul "0. Staging\actors\200_xavier.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\1104.igb"
	del >nul "0. Staging\actors\1104.igb"
	del >nul "0. Staging\hud\hud_head_1104.igb"
	del >nul "0. Staging\ui\hud\characters\1104.igb"
)
goto compilePCcont
