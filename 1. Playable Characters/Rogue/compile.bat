@echo off
echo Compiling Rogue's character assets 
...
set pcPkgb=rogue_0701.pkgb.json
set pcPkgbNc=rogue_0701_nc.pkgb.json

REM fill in the name of the character's talents file here (without the file extension)
set talentsName=rogue
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\07_rogue.igb"
	del >nul "0. Staging\actors\128_civilian_male.igb"
	del >nul "0. Staging\actors\200_rogue.igb"
	del >nul "0. Staging\3. No Cel Shade Assets\actors\0709.igb"
	del >nul "0. Staging\actors\0709.igb"
	del >nul "0. Staging\hud\hud_head_0709.igb"
	del >nul "0. Staging\ui\hud\characters\0709.igb"
)
goto compilePCcont
