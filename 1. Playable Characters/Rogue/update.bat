...
set codexEntry=Rogue
set dangerEntry=Rogue
set herostatEntry=Rogue
set itemsEntry=Rogue
set npcstatEntry1=Rogue_MC
set npcstatEntry2=RogueSimple
set npcstatEntry3=""
set reviewEntry=Rogue
