@echo off
echo Compiling Dark Phoenix's character assets 
...
set pcPkgb=darkphoenix_0211.pkgb.json
set pcPkgbNc=darkphoenix_0211_nc.pkgb.json
...
set simpleCompilePlayable=simpleCompile_DarkPhoenix
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\3. No Cel Shade Assets\actors\0219.igb"
	del >nul "0. Staging\actors\0219.igb"
	del >nul "0. Staging\hud\hud_head_0219.igb"
	del >nul "0. Staging\ui\hud\characters\0219.igb"
)
goto compilePCcont
