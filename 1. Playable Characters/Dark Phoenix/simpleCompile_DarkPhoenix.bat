@echo off
echo Compiling Playable Character - Dark Phoenix
...
set packageName=darkphoenix_02
REM playable characters need the name of the xml packages listed as well
set xmlPackageName=darkphoenix_xml
REM define other values for the compiler
set comicCover=""
set effectsFolder=drkphoenx
set loadingScreen1=0203
set loadingScreen2=""
set loadingScreen3=""
set powerstyle=ps_darkphoenix
set soundFile=darkp_m
