...
copy >nul "1. Base Assets\1. Data Entries\Codex_IronMan.json" "..\..\3. General Data Files\codex\1. Base Assets\0. Codex Entries\IronMan.json"
copy >nul "1. Base Assets\1. Data Entries\Herostat_IronMan.txt" "..\..\3. General Data Files\herostat\1. Base Assets\0. Herostat Entries\IronMan.txt"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_IronManSimple.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\IronManSimple.json"
copy >nul "1. Base Assets\1. Data Entries\NPCstat_TonyStark.json" "..\..\3. General Data Files\npcstat\1. Base Assets\0. NPCstat Entries\TonyStark.json"
copy >nul "1. Base Assets\1. Data Entries\ReviewPaths_IronMan.json" "..\..\3. General Data Files\review_paths\1. Base Assets\0. Review_Paths Entries\IronMan.json"
