@echo off
echo Compiling Iron Man's character assets 
...
set pcPkgb=ironman_1501.pkgb.json
set pcPkgbNc=ironman_1501_nc.pkgb.json

REM fill in the name of the character's NPC packages here (without the file extension)
set npcName1=ironmansimple_1501
set npcName2=tonystark_11601
set npcName3=""
set npcName4=""
set npcName5=""
set npcName6=""
...
set simpleCompilePlayable=simpleCompile_IronMan
set simpleCompileNPC1=simpleCompile_IronManSimple
set simpleCompileNPC2=simpleCompile_TonyStark
