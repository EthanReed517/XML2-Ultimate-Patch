...
set codexEntry=Magneto
set dangerEntry=Magneto
set herostatEntry=Magneto
set itemsEntry=Magneto
set npcstatEntry1=Magneto_MC
set npcstatEntry2=MagnetoSimple
set npcstatEntry3=""
set npcstatEntry4=""
set npcstatEntry5=""
set npcstatEntry6=""
set reviewEntry=Magneto
