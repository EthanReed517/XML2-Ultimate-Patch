...
Magneto - Ultimate XML1 (Unmasked) Skin
By BaconWizard17

General Information
- The file called 25XX (Skin).igb is the skin. It goes in the Actors folder.
- The file called 25XX (Skin - No Cel).igb is the skin but without the cel shading (black outline). It goes in the Actors folder. It is an alternative to the main skin, so use one or the other. 
- The file called hud_head_25XX.igb is the conversation portrait for this skin. It goes in the HUD folder.
- The file called 25XX (3D Head).igb is the 3D head for this skin. It goes in the folder ui/hud/characters

Hex editing info:
- The internal number of the skin is 2501.
- The internal number of the conversation portrait is 2501.
- The internal number of the 3D head is 2501.
