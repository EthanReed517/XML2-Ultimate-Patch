...
Toad - Astral Gladiator (Purple) Skin
By BaconWizard17

General Information
- The file called 33XX (Skin).igb is the skin. It goes in the Actors folder.
- The file called 33XX (Skin - No Cel).igb is the skin but without the cel shading (black outline). It goes in the Actors folder. It is an alternative to the main skin, so use one or the other. 
- The file called hud_head_33XX.igb is the conversation portrait for this skin. It goes in the HUD folder.
- The file called 33XX (3D Head).igb is the 3D head for this skin. It goes in the folder ui/hud/characters.

Hex editing info:
- The internal number of the skin is 3301.
- The internal number of the conversation portrait is 3301.
- The internal number of the 3D head is 3301.
