@echo off
echo Compiling Abyss's NPC assets 
...
if  %consoleChoice%==PC (
	del >nul "0. Staging\actors\40_abyss.igb"
	del >nul "0. Staging\actors\40_abyss_arm_l.igb"
	del >nul "0. Staging\actors\40_abyss_arm_r.igb"
	del >nul "0. Staging\actors\40_abyss_chest.igb"
	del >nul "0. Staging\actors\134_abyss_apoc.igb"
	del >nul "0. Staging\actors\134_abyss_apoc_arm_l.igb"
	del >nul "0. Staging\actors\134_abyss_apoc_arm_r.igb"
	del >nul "0. Staging\actors\134_abyss_apoc_chest.igb"
