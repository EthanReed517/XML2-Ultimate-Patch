@echo off
echo Compiling Shock Trooper's character assets 
...
set npcName1=petrovitch
set npcNum1=9601
set npcName2=shocktrooper_a
set npcNum2=9601
set npcName3=shocktrooper_b
set npcNum3=9601
set npcName4=shocktrooper_c
set npcNum4=9601
set npcName5=""
set npcNum5=""
set npcName6=""
