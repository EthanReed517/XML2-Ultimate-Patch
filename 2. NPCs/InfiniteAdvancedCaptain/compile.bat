@echo off
echo Compiling Infinite Advanced Captain's character assets 
...
set npcName1=infiniteadvancedcaptain_a
set npcNum1=7001
set npcName2=infiniteadvancedcaptain_b
set npcNum2=7002
set npcName3=infiniteadvancedcaptain_c
set npcNum3=7003
set npcName4=""
set npcNum4=""
set npcName5=""
