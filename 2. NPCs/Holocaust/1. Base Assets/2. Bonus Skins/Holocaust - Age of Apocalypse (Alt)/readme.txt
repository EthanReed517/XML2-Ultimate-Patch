...
Holocaust - Age of Apocalypse (Alt) Skin
By BaconWizard17

General Information
- The file called 46XX (Skin).igb is the skin. It goes in the Actors folder.
- The file called 46XX (Skin - No Cel).igb is the skin but without the cel shading (black outline). It goes in the Actors folder. It is an alternative to the main skin, so use one or the other. 
- The file called hud_head_46XX.igb is the conversation portrait for this skin. It goes in the HUD folder.
- The file called 46XX (3D Head).igb is the 3D head for this skin. It goes in the folder 

Hex editing info:
- The internal number of the skin is 4601.
- The internal number of the conversation portrait is 4601.
- The internal number of the 3D head is 4601.
