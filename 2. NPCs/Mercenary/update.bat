...
set herostatEntry=""
set itemsEntry=""
set npcstatEntry1=Mercenary_a
set npcstatEntry2=Mercenary_b
set npcstatEntry3=Mercenary_c
set npcstatEntry4=Mercenary_d
set npcstatEntry5=Mercenary_Guard
set npcstatEntry6=Mercenary_Guard_b
set reviewEntry=""
