...
copyOriginAndAngles("paint1", "exp_null4a" )
sound (  "PLAY_SOUND", "zone_shared/special/missle_track", "", "" )
act("paint1", "paint1" )
waittimed ( 2.000 )
sound (  "PLAY_SOUND", "zone_shared/special/missle_land", "", "" )
act("paint1", "paint1" )
copyOriginAndAngles("paint02", "exp_null4a" )
act("paint02", "paint02" )
waittimed ( 0.200 )
copyOriginAndAngles("paint_harm2", "exp_null4" )
copyOriginAndAngles("paint_harm", "exp_null4" )
waittimed ( 1.000 )
