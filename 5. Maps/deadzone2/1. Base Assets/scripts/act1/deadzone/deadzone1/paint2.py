...
copyOriginAndAngles("paint1", "exp_null2a" )
sound (  "PLAY_SOUND", "zone_shared/special/missle_track", "", "" )
act("paint1", "paint1" )
waittimed ( 2.000 )
sound (  "PLAY_SOUND", "zone_shared/special/missle_land", "", "" )
act("paint1", "paint1" )
copyOriginAndAngles("paint02", "exp_null2a" )
act("paint02", "paint02" )
waittimed ( 0.200 )
copyOriginAndAngles("paint_harm2", "exp_null2" )
copyOriginAndAngles("paint_harm", "exp_null2" )
waittimed ( 1.000 )
