...
robocopy >nul /e /v "2. Default Assets - GameCube\2. Bonus Comic Covers" "..\..\0. Ready Files\2. Bonus Comic Covers"
goto :end

:movePS2
robocopy >nul /e /v "2. Default Assets - PS2\textures" "..\..\0. Ready Files\assetsfb Files\textures"
robocopy >nul /e /v "2. Default Assets - PS2\2. Bonus Comic Covers" "..\..\0. Ready Files\2. Bonus Comic Covers"
goto :end
...
robocopy >nul /e /v "1. Base Assets\2. Bonus Comic Covers" "..\..\0. Ready Files\2. Bonus Comic Covers"
goto :end
